...
GUI.colors = {
  ...
  flat_button = {80, 80, 80, 1},    -- Element Frame
  ...
  txt_green = {40, 170, 40, 1},      -- Text green
  txt_red = {210, 40, 40, 1},      -- Text red
  txt_yellow = {251, 208, 0, 1},      -- Text yellow FBD000
  txt_muted = {100, 100, 100, 1},      -- Text dark grey
  txt_grey = {150, 150, 150, 1},    -- Header Background
  header_bg = {37, 37, 37, 1},    -- Header Background
