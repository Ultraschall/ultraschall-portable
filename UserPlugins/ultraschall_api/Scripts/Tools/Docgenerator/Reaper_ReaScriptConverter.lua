...
function contentindex()
  FunctionList=FunctionList.."<h2><img src=\"gfx/reaper.png\"><br>Reaper Reascript-Api-Documentation 5.982<br>\"Sincerity is the key to success. Once you learn to fake that, you've got it made.\"</h2><h3>The Functions Reference</h3><table style=\"font-size:10pt;\" width=\"100%\">"
  reaper.ClearConsole()
