...
Scythe.libPath=ultraschall.Api_Path.."/3rd_party_modules/Scythe/"

if not Scythe.libPath or Scythe.libPath == "" then
    reaper.MB("Couldn't find the Scythe library in scythe.lua. Please contact Ultraschall-API-developers to fix it.", "Unexpected error!", 0) -- luacheck: ignore 631
    return
end
